...
dataset = pd.read_csv('DL-ALGORITHMS/RNN/SMSSpamCollection.txt',sep='\t',names=['label','message'])
...
def plot_confusion_matrix(y_true, y_pred):
   ...
   plt.savefig('DL-ALGORITHMS/RNN/results/test.jpg')
...
model.save("DL-ALGORITHMS/RNN/results/model/spam_model")
